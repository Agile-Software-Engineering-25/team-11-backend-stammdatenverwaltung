...
class MinIOControllerTest {
  ...
  void getProfilePicture_WithValidId_Returns200AndImageData() throws Exception {
    // Given
    when(minIOService.getProfilePicture(TEST_USER_ID)).thenReturn(TEST_IMAGE_DATA);
  ...
  @Test
  @DisplayName("getProfilePicture_WithEmptyPicture_Returns200WithEmptyData")
  @WithMockUser
  void getProfilePicture_WithEmptyPicture_Returns200WithEmptyData() throws Exception {
    // Given
    when(minIOService.getProfilePicture(TEST_USER_ID)).thenReturn(new byte[0]);
  ...
  @Test
  @DisplayName("setProfilePicture_WhenCalled_Returns201")
  @WithMockUser
  void setProfilePicture_WhenCalled_Returns201() throws Exception {
    // Given
