...
public class UserSpecificationBuilder {
    ...
    public Specification<Person> buildSpecification(UserFilterRequestDTO filterRequest) {
        return (root, query, cb) -> {
            if (filterRequest == null || filterRequest.getFilter() == null || filterRequest.getFilter().isEmpty()) {
    ...
    private Predicate createPredicate(CriteriaBuilder cb, Path<?> path, FilterCriterionDTO criterion) {
